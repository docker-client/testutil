[![Build Status](https://img.shields.io/github/actions/workflow/status/docker-client/testutil/cd.yml?branch=main&style=for-the-badge)](https://github.com/docker-client/testutil/actions)
